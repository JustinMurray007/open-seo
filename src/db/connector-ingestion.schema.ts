...
export const connectorSyncCursors = sqliteTable(
...
export const gscDailyFacts = sqliteTable(
  "gsc_daily_facts",
  {
    id: text("id").primaryKey(),
    projectId: text("project_id")
...
export const ga4DailyLandingPageFacts = sqliteTable(
  "ga4_daily_landing_page_facts",
  {
    ...
    activeUsers: real("active_users").notNull().default(0),
    engagedSessions: real("engaged_sessions").notNull().default(0),
    engagementRate: real("engagement_rate").notNull().default(0),
    keyEvents: real("key_events").notNull().default(0),
    transactions: real("transactions").notNull().default(0),
